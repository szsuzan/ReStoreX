 ...
 * @param {import('../types/index.js').RecoveryProgress} props.progress
 */
export function RecoveryProgressDialog({ isOpen, onClose, onCancel, progress }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-96 max-w-[90vw]">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-gray-900">Recovering Files</h3>
          <button
            onClick={onClose}
        ...
        {/* Current File */}
        <div className="mb-6">
          <div className="text-sm text-gray-600 mb-2">Currently recovering:</div>
          <div className="bg-gray-50 p-3 rounded-lg border">
            <p className="text-sm font-medium text-gray-800 truncate" title={progress.currentFile}>
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center gap-3 text-sm">
            ...
            <span className="text-gray-600">Files recovered:</span>
            <span className="font-semibold text-gray-800">
              {progress.filesRecovered} / {progress.totalFiles}
            </span>
          </div>
